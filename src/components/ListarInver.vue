<template>
    ...
    <v-row class="text-center">      
      <v-col class="mb-4">
        <h2 class="display-2 font-weight-bold mb-3">
          Listado de Invernaderos/Parcelas
        </h2>       
      </v-col>        
    </v-row>
    <v-row>
    <v-col class="mb-1">
       <v-btn :to="{name:'CrearInver'}" class="mx-2" fab dark color="indigo">
    ...
    <v-col cols="12">
        ...
        <thead>
            ...
            <th class="text-center">Fecha muestreo</th>
            <th class="text-center">Lugar/Lote</th>
        ...
        <tbody>
            <tr v-for="articulo in articulos" :key="articulo.id">
                ...
                <td>
                    <v-btn :to="{name:'EditarInver', params:{id:articulo.id}}" fab small color="primary"><v-icon>mdi-pencil</v-icon></v-btn>
